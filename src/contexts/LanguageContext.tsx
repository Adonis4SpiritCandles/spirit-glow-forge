...
const translations = {
  en: {
    ...
    pricesPayment: 'Prices & Payment',
    pricesPl: 'Prices are displayed in PLN and EUR',
    pricesIncludeVat: 'All prices include VAT (23% in Poland)',
    paymentViaStripe: 'Payment is processed securely via Stripe',
    paymentMethods: 'We accept: Visa, Mastercard, PayPal, Przelewy24',
    shippingDelivery: 'Shipping & Delivery',
    shippingPoland: 'We ship to Poland and select EU countries',
    shippingCalculated: 'Shipping costs are calculated at checkout based on destination',
    deliveryTime: 'Estimated delivery: 3-7 business days (Poland), 7-14 days (EU)',
    riskOfLoss: 'Risk of loss passes to you upon delivery to the carrier',
    rightOfWithdrawal: 'Right of Withdrawal (EU Consumer Law)',
    withdrawalPeriod: 'You have 14 days from delivery to withdraw from the purchase',
    returnConditions: 'Products must be unused, in original packaging, with all tags attached',
    nonRefundableCustom: 'Personalized/custom products cannot be returned',
    returnProcess: 'To initiate a return, contact us at m5moffice@proton.me',
    refundTimeframe: 'Refunds will be processed within 14 days of receiving the return',
    productQuality: 'Product Quality & Defects',
    qualityGuarantee: 'All products are hand-inspected before shipping',
    defectNotification: 'Defective products: Contact us within 7 days of delivery',
    defectResolution: 'We will replace defective products or issue a full refund',
    damagedShipment: 'Damaged shipment: Report to carrier and us immediately',
    liabilityLimitations: 'Liability Limitations',
    liabilityMaximum: 'Our liability is limited to the purchase price of the product',
    excludedDamages: 'We are not liable for indirect, incidental, or consequential damages',
    forceClause: 'We are not responsible for delays caused by force majeure events',
    disputeResolutionTerms: 'Dispute Resolution',
    governingLaw: 'These terms are governed by Polish law',
    jurisdiction: 'Disputes will be resolved in courts of Warsaw, Poland',
    euConsumerPlatform: 'EU consumers can use the ODR platform: https://ec.europa.eu/consumers/odr',
    contactForTerms: 'Questions about these terms:',
  ...
  pl: {
    ...
    pricesPayment: 'Ceny i Płatność',
    pricesPl: 'Ceny są wyświetlane w PLN i EUR',
    pricesIncludeVat: 'Wszystkie ceny zawierają VAT (23% w Polsce)',
    paymentViaStripe: 'Płatności są bezpiecznie przetwarzane przez Stripe',
    paymentMethods: 'Akceptujemy: Visa, Mastercard, PayPal, Przelewy24',
    shippingDelivery: 'Wysyłka i Dostawa',
    shippingPoland: 'Wysyłamy do Polski i wybranych krajów UE',
    shippingCalculated: 'Koszty wysyłki są obliczane przy kasie na podstawie miejsca docelowego',
    deliveryTime: 'Szacowany czas dostawy: 3-7 dni roboczych (Polska), 7-14 dni (UE)',
    riskOfLoss: 'Ryzyko utraty przechodzi na Ciebie po dostawie do przewoźnika',
    rightOfWithdrawal: 'Prawo Odstąpienia od Umowy (Prawo Konsumenckie UE)',
    withdrawalPeriod: 'Masz 14 dni od dostawy na odstąpienie od zakupu',
    returnConditions: 'Produkty muszą być nieużywane, w oryginalnym opakowaniu, ze wszystkimi metkami',
    nonRefundableCustom: 'Produkty spersonalizowane/niestandardowe nie podlegają zwrotowi',
    returnProcess: 'Aby rozpocząć proces zwrotu, skontaktuj się z nami pod adresem m5moffice@proton.me',
    refundTimeframe: 'Zwroty pieniędzy będą przetwarzane w ciągu 14 dni od otrzymania zwrotu',
    productQuality: 'Jakość Produktu i Wady',
    qualityGuarantee: 'Wszystkie produkty są sprawdzane przed wysyłką',
    defectNotification: 'Wadliwe produkty: Skontaktuj się z nami w ciągu 7 dni od dostawy',
    defectResolution: 'Wymienimy wadliwe produkty lub zwrócimy pełną kwotę',
    damagedShipment: 'Uszkodzona przesyłka: Zgłoś przewoźnikowi i nam natychmiast',
    liabilityLimitations: 'Ograniczenia Odpowiedzialności',
    liabilityMaximum: 'Nasza odpowiedzialność jest ograniczona do ceny zakupu produktu',
    excludedDamages: 'Nie ponosimy odpowiedzialności za szkody pośrednie, przypadkowe lub wynikowe',
    forceClause: 'Nie ponosimy odpowiedzialności za opóźnienia spowodowane siłą wyższą',
    disputeResolutionTerms: 'Rozwiązywanie Sporów',
    governingLaw: 'Niniejszy regulamin podlega prawu polskiemu',
    jurisdiction: 'Spory będą rozstrzygane w sądach w Warszawie, Polska',
    euConsumerPlatform: 'Konsumenci UE mogą korzystać z platformy ODR: https://ec.europa.eu/consumers/odr',
    contactForTerms: 'Pytania dotyczące tych warunków:',
    ...
    keyboardNavigation: 'Nawigacja Klawiaturowa',
    ...
    colorContrast: 'Kontrast Kolorów',
