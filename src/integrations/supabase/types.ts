    ...
    Tables: {
      ...
      header_settings: {
        Row: {
          ...
          mobile_logo_animation: Json | null
          mobile_logo_height: string | null
          ...
          tablet_logo_animation: Json | null
          tablet_logo_height: string | null
      ...
      profile_comment_reactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "profile_comment_reactions_comment_id_fkey"
            columns: ["comment_id"]
            isOneToOne: false
            referencedRelation: "profile_comments"
            referencedColumns: ["id"]
      ...
      reorder_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "reorder_history_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["user_id"]
          ...
          {
            foreignKeyName: "reorder_history_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
