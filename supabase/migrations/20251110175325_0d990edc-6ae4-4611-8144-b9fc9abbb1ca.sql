-- Fix create_notification to normalize type and always set title and message
...
DECLARE
  ...
  v_badge text;
BEGIN
  -- Normalize type to match CHECK constraint (order, message, referral, tracking, general)
  ...
  -- Derive safe title and message based on original type/metadata
