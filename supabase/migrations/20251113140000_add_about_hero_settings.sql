-- Add advanced hero image settings to about_settings
...
COMMENT ON COLUMN public.about_settings.hero_animation_enabled IS 'Enable/disable hero image animation';
